    ...
    <div className="space-y-8 pb-20 p-6 md:p-8 bg-gray-50/50 min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-2 font-medium ml-1">
            {selectedIds.length > 0 ? (
              <span className="text-[#d19900] font-bold bg-[#d19900]/10 px-2 py-0.5 rounded">
        ...
        <div className="flex flex-wrap gap-3 w-full lg:w-auto items-center">
          <div className="flex bg-gray-50 p-1.5 rounded-xl border border-gray-100 gap-1">
            ...
            {isGeneratingPdf ? (
              ...
              <button
                ...
                className="p-2.5 rounded-lg text-gray-500 hover:text-[#d19900] hover:bg-white hover:shadow-sm transition-all"
          ...
          <div className="flex gap-2">
            <button
              ...
              className="p-3 bg-white border border-gray-200 text-gray-600 rounded-xl hover:border-[#d19900]/50 hover:text-[#d19900] transition-colors shadow-sm"
              title="Categorias"
            >
              <FolderTree size={18} />
            </button>
            ...
            <button
              ...
              className="p-3 bg-white border border-gray-200 text-gray-600 rounded-xl hover:border-green-200 hover:text-green-600 transition-colors shadow-sm"
      ...
      <div className="flex flex-col md:flex-row gap-4 bg-white p-2 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <div className="flex-grow relative group">
          <Search
            className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#d19900] transition-colors"
            size={20}
          />
          <input
            type="text"
                ...
                >
                  ...
                  <div className="h-64 relative bg-gray-50 overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-3 backdrop-blur-[2px]">
                      <button
                        ...
                        className="p-3.5 bg-white text-[#4a4a4a] rounded-2xl hover:scale-110 hover:text-[#d19900] transition-all shadow-lg"
                        title="Editar"
                      >
                        <Edit size={20} />
                      </button>
                      <button
                        ...
                        className="p-3.5 bg-white text-[#4a4a4a] rounded-2xl hover:scale-110 hover:text-amber-600 transition-all shadow-lg"
                        title="Estoque"
                      >
                        <History size={20} />
                      </button>
                      <button
                        ...
                        className="p-3.5 bg-white text-[#4a4a4a] rounded-2xl hover:scale-110 hover:text-red-600 transition-all shadow-lg"
                        title="Excluir"
                      >
                        <Trash2 size={20} />
                      </button>
                  ...
                  <div className="p-5 flex-grow flex flex-col justify-between bg-white">
                    <div>
                      ...
                      <h3
                        className="font-bold text-[#4a4a4a] text-base leading-tight line-clamp-2 mb-1 group-hover:text-[#d19900] transition-colors"
                        title={p.name}
                      >
                        {p.name}
                      </h3>
      ...
      <ProdutoFormModal
        ...
        onProdutoSalvo={handleSaveSuccess}
