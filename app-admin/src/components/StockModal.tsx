        ...
        <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50">
          <div>
            ...
            <p className="text-sm text-gray-500">
              {product.name} (Atual:{' '}
              <strong className="text-gray-900">{product.quantity}</strong>)
            </p>
          </div>
          <button
            onClick={onClose}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={
                      type === 'entry'
                        ? 'Ex: Reposição de fornecedor'
                        : 'Ex: Venda balcão ou Defeito'
                    }
                  />
                </div>
              </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            {new Date(log.createdAt).toLocaleDateString()} às{' '}
                            {new Date(log.createdAt)
                              .toLocaleTimeString()
                              .slice(0, 5)}{' '}
                            • por {log.user.split('@')[0]}
                          </p>
                        </div>
                      </div>
