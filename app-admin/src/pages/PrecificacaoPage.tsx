...
export function PrecificacaoPage() {
  ...
  const [resultado, setResultado] = useState<ResultadoPrecificacao | null>(
    null
  );
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card>
            <form onSubmit={calcularPreco} className="space-y-4">
              <h2 className="text-xl font-semibold text-carvao">
                Custos Diretos (Quanto você paga)
              </h2>
        ...
        <div className="lg:col-span-1 space-y-4">
          <Card delay={0.1}>
            <h2 className="text-xl font-semibold mb-4 text-carvao">
              Resultado
            </h2>
            {resultado ? (
              <div className="space-y-4">
                ...
                <div className="bg-dourado/10 p-4 rounded-lg text-center border border-dourado">
                  <p className="text-sm font-medium text-carvao uppercase">
                    Preço de Venda Sugerido
                  </p>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between text-gray-700">
                    ...
                    <span className="font-medium text-red-600">
                      - R$ {resultado.taxaValor.toFixed(2)}
                    </span>
                  </div>
                  <hr />
