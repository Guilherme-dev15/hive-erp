...
var uploadImageToFirebase = function (file_1) {
    var args_1 = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        args_1[_i - 1] = arguments[_i];
    }
    return __awaiter(void 0, __spreadArray([file_1], args_1, true), void 0, function (file, folder) {
        var cleanName, fileName, storageRef, snapshot, downloadURL, error_1;
        if (folder === void 0) { folder = "produtos"; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!file)
                        throw new Error("Nenhum ficheiro fornecido.");
                    cleanName = file.name.replace(/[^a-zA-Z0-9.]/g, "_");
                    fileName = "".concat(Date.now(), "_").concat(cleanName);
                    storageRef = (0, storage_1.ref)(firebaseConfig_1.storage, "".concat(folder, "/").concat(fileName));
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
