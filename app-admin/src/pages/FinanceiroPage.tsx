    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-end md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Gerencie entradas e saídas manualmente.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <form onSubmit={handleAdd} className="space-y-4">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full py-3 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 active:scale-95 transition-all shadow-lg shadow-indigo-200 flex items-center justify-center gap-2"
                >
          ...
          <motion.div
            variants={itemVariants}
            className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hidden lg:block"
          >
        ...
        <motion.div
          variants={itemVariants}
          className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col overflow-hidden h-fit min-h-[500px]"
        >
          {/* Barra de Filtro */}
                      ...
                      >
                        <td className="p-4 pl-6">
                          <div className="flex items-center gap-3">
                            <div
                              className={`p-2 rounded-lg ${isEntrada ? 'bg-emerald-50 text-emerald-600' : 'bg-rose-50 text-rose-600'}`}
                            >
                              {isEntrada ? (
                                <TrendingUp size={16} />
                              ) : (
                        ...
                        <td
                          className={`p-4 text-right font-bold text-sm ${isEntrada ? 'text-emerald-600' : 'text-rose-500'}`}
                        >
                          {isEntrada ? '+' : '-'}{' '}
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className={`text-sm font-medium mt-1 ${subTextClass}`}>{title}</p>
      </div>
    </motion.div>
  );
}
