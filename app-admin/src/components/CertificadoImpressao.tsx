...
export const CertificadoImpressao = forwardRef<
  HTMLDivElement,
  CertificadoProps
>(({ pedido, config }, ref) => {
  ...
  return (
    <div style={{ display: 'none' }}>
      ...
      >
        {/* Borda Decorativa */}
        <div
          className="border-8 border-double p-8 h-full relative"
          style={{ borderColor: primaryColor }}
        >
          {/* Cabeçalho */}
          <div className="text-center mb-8">
            <h1
              className="text-4xl font-serif font-bold uppercase tracking-widest mb-2"
          ...
          <div className="text-center space-y-6 mb-8">
            <p className="text-lg">
              ...
              <strong className="block text-xl mt-2 mb-2 font-serif">
                {pedido.customerName || 'Cliente Especial'}
              </strong>
              são confeccionadas em <strong>Prata 925</strong> legítima e
              possuem garantia vitalícia quanto à autenticidade do metal.
            </p>
            ...
            <div className="text-left bg-gray-50 p-4 rounded-lg text-sm w-3/4 mx-auto">
              <p className="font-bold text-center mb-2 text-gray-400 text-xs uppercase">
                Itens Cobertos
              </p>
          ...
          <div className="text-center mt-12 pt-4 border-t border-gray-200">
            ...
            {whatsApp && (
              <p className="text-sm text-gray-400">WhatsApp: {whatsApp}</p>
            )}
