...
exports.CertificadoImpressao = void 0;
...
exports.CertificadoImpressao = (0, react_1.forwardRef)(function (_a, ref) {
    var pedido = _a.pedido, config = _a.config;
    if (!pedido)
        return null;
    // Cores e Configurações (com fallbacks)
    var primaryColor = (config === null || config === void 0 ? void 0 : config.primaryColor) || '#D4AF37';
    var storeName = (config === null || config === void 0 ? void 0 : config.storeName) || 'HivePratas';
    var warrantyText = (config === null || config === void 0 ? void 0 : config.warrantyText) || 'Garantia de 90 dias contra defeitos de fabricação.';
    var whatsApp = (config === null || config === void 0 ? void 0 : config.whatsappNumber) || '';
            ...
            <div className="text-center space-y-6 mb-8">
              ...
              <div className="text-left bg-gray-50 p-4 rounded-lg text-sm w-3/4 mx-auto">
                ...
                <ul className="space-y-1">
                  {pedido.items.map(function (item, idx) { return (<li key={idx} className="flex justify-between border-b border-gray-200 last:border-0 pb-1 last:pb-0">
...
exports.CertificadoImpressao.displayName = 'CertificadoImpressao';
