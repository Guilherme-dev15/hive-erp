...
const FormInput: React.FC<FormInputProps> = ({
  ...
  <div className={className}>
    {label && (
      <label
        htmlFor={String(name)}
        className="block text-[10px] font-bold text-gray-500 uppercase mb-1.5 tracking-wider ml-1"
      >
        {label}
      </label>
    )}
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-8 py-6 border-b border-gray-100 bg-white sticky top-0 z-20">
              ...
              <button
                onClick={onClose}
                className="p-2.5 hover:bg-gray-100 rounded-full text-gray-400 hover:text-red-500 transition-all active:scale-90"
              >
                <X size={22} />
              </button>
            </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="p-8">
                  ...
                  <div className="lg:col-span-5 space-y-6">
                    <div className="bg-gray-50/50 p-5 rounded-2xl border border-gray-100 shadow-sm group">
                      ...
                      <div className="flex gap-4 items-center">
                        ...
                        <div className="flex-1">
                          ...
                          <label
                            htmlFor="upload"
                            className="flex flex-col items-center justify-center w-full h-28 border-2 border-dashed border-gray-200 rounded-2xl cursor-pointer hover:border-[#d19900] hover:bg-white transition-all group/label"
                          >
                    ...
                    <div className="space-y-4">
                      <FormInput
                        ...
                        placeholder="Ex: Corrente Veneziana"
                      />
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center px-1">
                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest flex items-center gap-1.5">
                          <Scale size={12} /> Precificação por Peso
                        </span>
                        <button
                          type="button"
                  ...
                  <div className="flex justify-between items-end mb-4">
                    <div>
                      <h3 className="text-sm font-black text-gray-700 uppercase tracking-wider flex items-center gap-2">
                        <Layers size={16} className="text-[#d19900]" /> Grades e
                        Variações
                      </h3>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        type="button"
                        onClick={addVariante}
                        className="text-xs bg-black text-white px-4 py-2 rounded-xl font-bold flex items-center gap-2 hover:bg-gray-800 transition-colors shadow-lg shadow-black/10"
                      >
                  ...
                  {!variantesObs || variantesObs.length === 0 ? (
                    ...
                    <div className="space-y-3">
                        ...
                        >
                          ...
                          <div className="col-span-3 flex items-center gap-2">
                            <label className="flex items-center gap-2 cursor-pointer text-[10px] font-bold text-gray-600 select-none hover:text-black">
                              <input
                                type="checkbox"
                                {...register(`variantes.${index}.sob_consulta`)}
                                className="w-4 h-4 rounded text-[#d19900] focus:ring-[#d19900] border-gray-300"
                              />
                              Sob Consulta
                            </label>
                          </div>
                      ...
                      <div className="flex justify-end pt-2">
                        <button
                          type="button"
                          onClick={updateTotalStock}
                          className="text-[10px] font-bold text-blue-600 hover:underline flex items-center gap-1"
                        >
                          <Copy size={12} /> Somar estoque das grades para o
                          total
                        </button>
                      </div>
                    </div>
                ...
                <div className="flex justify-end gap-4 mt-8 pt-4">
                  <button
                    type="button"
                    onClick={onClose}
                    className="px-6 py-3 text-sm font-bold text-gray-500 hover:text-gray-800 transition-colors uppercase tracking-widest"
                  >
                    Cancelar
                  </button>
                  <button
                    ...
                    className="bg-[#4a4a4a] hover:bg-black text-white px-10 py-3 rounded-2xl font-black shadow-xl shadow-gray-200 flex items-center gap-3 transition-all active:scale-95 disabled:opacity-50 tracking-widest uppercase text-xs"
                  >
                    {isSubmitting ? (
