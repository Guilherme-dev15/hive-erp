...
import { Loader2, Download, Package, AlertTriangle, TrendingUp } from "lucide-react";
...
export function RelatoriosPage() {
    ...
    const { curvaABC, resumoEstoque } = useMemo(() => {
        ...
        // 1. Resumo de Estoque
        const resumo: ResumoEstoque = produtos.reduce((acc, p) => {
    ...
    if (loading) {
        return <div className="flex justify-center p-10"><Loader2 className="animate-spin text-dourado"/></div>;
    }
