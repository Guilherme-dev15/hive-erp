    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          ...
          <button
            onClick={() => openModal()}
            className="bg-carvao text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-gray-800 transition-colors shadow-md"
          >
            <Plus size={20} /> Novo
          </button>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center p-10 text-gray-400 bg-white rounded-xl border border-gray-100">
          ...
          {filtered.map((f) => (
            ...
            >
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                {f.paymentTerms && (
                  <div className="flex items-center gap-2">
                    <Truck size={14} className="text-dourado" />{' '}
          ...
          >
            <div className="flex justify-between items-center p-4 border-b bg-gray-50">
              <h3 className="font-bold text-gray-800">
                {provider ? 'Editar Fornecedor' : 'Novo Fornecedor'}
              </h3>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-4 space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button
                  ...
                  className="bg-carvao text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-gray-800 flex items-center gap-2"
                >
                  {isSubmitting && (
