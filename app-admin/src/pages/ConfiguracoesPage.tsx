...
const InputGroup = ({ label, children, description }: any) => (
  <div className="space-y-1.5 w-full">
    ...
    {children}
    {description && (
      <p className="text-[11px] text-gray-400 ml-1">{description}</p>
    )}
  </div>
);
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-2 text-lg">
            Personalize a identidade visual e as regras de negócio.
          </p>
        </div>
        {formData.slug && (
          <a
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            <SectionHeader
              ...
              description="Defina como sua marca aparece para o cliente."
            />

            <div className="space-y-5">
              <InputGroup
                label="Nome da Loja"
                description="Nome exibido no cabeçalho."
              >
                ...
                <InputGroup label="Cor Principal">
                  <div className="flex items-center gap-2 p-2 bg-gray-50 border border-gray-200 rounded-xl">
                    ...
                    <input
                      ...
                      value={formData.primaryColor}
                      onChange={handleChange}
                      className="w-full bg-transparent border-none text-xs font-mono uppercase focus:ring-0"
                    />
                  </div>
                </InputGroup>
          ...
          >
            <SectionHeader
              icon={Calculator}
              title="Custos & Metas"
              description="Dados para cálculo automático de lucro."
            />
            ...
            <div className="space-y-5">
              ...
              <InputGroup
                label="Meta Mensal de Lucro (R$)"
                description="Valor alvo para o Dashboard."
              >
                <div className="relative">
                  <Target
                    className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"
          ...
          >
            <SectionHeader
              icon={Smartphone}
              title="Atendimento"
              description="Canais de contato e stock."
            />

            <div className="space-y-5">
              <InputGroup
                label="WhatsApp (Com DDD)"
                description="Para onde os pedidos serão enviados."
              >
                <div className="relative">
                  <Smartphone
              ...
              <InputGroup
                ...
                description="Quantidade mínima para avisar reposição."
              >
                <div className="relative">
                  <BellRing
          ...
          >
            <SectionHeader
              ...
              description="Texto que sai no PDF de impressão."
            />
            <textarea
              name="warrantyText"
