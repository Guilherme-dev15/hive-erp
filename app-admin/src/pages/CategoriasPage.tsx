...
export function CatalogoPage() {
  ...
  // Modal de Detalhes
  const [selectedProduct, setSelectedProduct] = useState<ProdutoStore | null>(
    null
  );
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        {loading ? (
          <div className="flex justify-center py-20">
            <div className="animate-spin w-8 h-8 border-4 border-[#d19900] border-t-transparent rounded-full"></div>
          </div>
        ) : (
              ...
              >
                <div className="aspect-[4/5] overflow-hidden bg-gray-100 relative">
                  <img
                    src={
                      produto.imageUrl ||
                      'https://placehold.co/400x500/f3f4f6/a3a3a3?text=Sem+Foto'
                    }
            ...
            >
              ...
              <div className="w-full md:w-1/2 p-6 md:p-10 flex flex-col bg-white overflow-y-auto">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <button
                    onClick={() => setSelectedProduct(null)}
                    className="hidden md:block p-2 hover:bg-gray-100 rounded-full text-gray-400"
                  >
                    <X size={24} />
                  </button>
                </div>
